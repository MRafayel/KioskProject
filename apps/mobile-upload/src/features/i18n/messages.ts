...
const hy = {
  ...
  chooseAnother: "Ավելացնել ևս ֆայլեր",
  fileHint: "PDF, JPEG կամ PNG · մինչև {size}",
  dropHint: "կամ քաշեք ֆայլերն այստեղ",
  remainingSlots: "Կարող եք ավելացնել ևս {remaining} փաստաթուղթ՝ {max}-ից",
  fileLimitReached: "Ավելացվել են բոլոր {max} փաստաթղթերը",
...
const ru: Messages = {
  ...
  chooseAnother: "Добавить ещё файлы",
  fileHint: "PDF, JPEG или PNG · не более {size}",
  dropHint: "или перетащите файлы сюда",
  remainingSlots: "Можно добавить ещё {remaining} документов из {max}",
  fileLimitReached: "Добавлены все {max} документов",
...
const en: Messages = {
  ...
  chooseAnother: "Add more files",
  fileHint: "PDF, JPEG, or PNG · up to {size}",
  dropHint: "or drop them here",
  remainingSlots: "You can add {remaining} more of {max} documents",
  fileLimitReached: "All {max} documents added",
