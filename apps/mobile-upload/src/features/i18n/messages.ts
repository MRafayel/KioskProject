...
const hy = {
  ...
  statusQuarantined: "Ընդունված է · սպասում է անվտանգ ստուգման",
  statusValidating: "Ստուգվում է · պատրաստում ենք տպման էջերը",
  statusReady: "Ստուգված է · պատրաստ է տպման",
  ...
  rejectionGeneric: "Չհաջողվեց անվտանգ պատրաստել ֆայլը։ Ընտրեք մեկ այլ ֆայլ։",
